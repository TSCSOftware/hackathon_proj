...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_189079636",
    "indexes": [
      "CREATE INDEX `idx_8qFiPt3vxE` ON `availability_exceptions` (\n  `slot_date`,\n  `provider`\n)",
      "CREATE INDEX `idx_fGB4hLANTO` ON `availability_exceptions` (\n  `slot_date`,\n  `status`\n)"
    ],
    "listRule": null,
  ...
  const collection = app.findCollectionByNameOrId("pbc_189079636");
